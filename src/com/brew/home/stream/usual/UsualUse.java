package com.brew.home.stream.usual;
...
public class UsualUse {
    ...
    public static void main(String[] args) throws InterruptedException {
        new UsualUse().mapTest();
        new UsualUse().groupByTest();
        new UsualUse().summing();
        new UsualUse().sort();
        new UsualUse().sumTest();
        new UsualUse().collectTest();
        new UsualUse().reduceTest();
        new UsualUse().parallelStreamTest();
        new UsualUse().concurrentMapTest();
    }
